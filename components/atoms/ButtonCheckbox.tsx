  ...
  return (
    ...
    >
      <div className="relative z-10 flex items-center justify-center">
        <div
          className={clsx(
            'ease-power4-in-out absolute -z-10 h-4 w-4 rounded-full transition-transform duration-500',
            selected
              ? 'bg-blue scale-[25]'
              : 'bg-blue-30 scale-0 group-hover/button-checkbox:scale-[25]',
          )}
        />
        {/* <div
          className={clsx(
            'bg-blue-30 ease-power4-in-out absolute -z-10 h-4 w-4 rounded-full transition-transform duration-500',
        ...
        <IconCross
          ...
          className={clsx(
            ...
            selected
              ? 'rotate-135 group-hover/button-checkbox:rotate-225'
              : 'rotate-0 group-hover/button-checkbox:rotate-90',
          )}
